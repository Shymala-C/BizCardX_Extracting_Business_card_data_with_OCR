...
mydb = mysql.connector.connect(
    user='root',
    host='localhost',
    password='Shymala@5466', auth_plugin='mysql_native_password')
...
icon = Image.open("C:\\Users\\shaml\\PycharmProjects\\Bizcardx\\Bizcardx_image.jpg")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By ARUNKUMAR BAIRAVAN",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *Shymala*!"""})
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open("C:\\Users\\shaml\\PycharmProjects\\Bizcardx\\Bizcardx_image.jpg"), width=500)
